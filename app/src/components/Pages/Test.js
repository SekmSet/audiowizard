...
function Test() {
  ...
  const { setFullName, lastName, firstName, setGender, gender } = useContext(
    AppContext
  );
    ...
    <Stepper currentStep={step} setStep={setStep}>
      ...
      <div className="step">
        ...
        <Button
          ...
          className={classNames({ active: gender === Homme })}
          onClick={(e) => onSubmitStep2(Homme)}
        >
          Homme
        </Button>
        <Button
          variant="outline-dark"
          className={classNames({ active: gender === Femme })}
          onClick={(e) => onSubmitStep2(Femme)}
        >
          Femme
        </Button>
      </div>
